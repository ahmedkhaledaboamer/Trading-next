...
const steps = [
  {
    ...
    desc: 'يتم استقبال الطلب عبر منسّق الاتصال وتسجيله بدقة',
  },
  {
    title: 'توجيه الطلب',
    icon: ArrowLeftRightIcon,
    desc: 'يتم تحويله مباشرة إلى مستشار الحسابات أو فريق الاستيراد/التصدير',
  },
  {
    title: 'التواصل مع العميل',
    icon: HeadphonesIcon,
    desc: 'تحديد الاحتياجات، توضيح التفاصيل، وتقديم الحلول المناسبة',
  },
  {
    title: 'بدء التنفيذ',
    icon: PlayIcon,
    desc: 'يبدأ فريق التشغيل بتنفيذ الطلب وفق خطة واضحة',
  },
  {
    title: 'متابعة مستمرة',
    icon: ActivityIcon,
    desc: 'تتبع الشحنات، تحديث العميل، وضمان الالتزام بالوقت',
  },
  {
    title: 'مراجعة الجودة',
    icon: CheckCircleIcon,
    desc: 'مدقق الجودة يتأكد من أن كل خطوة تمت بالشكل الصحيح',
  },
  {
    title: 'التقييم والتحسين',
    icon: TrendingUpIcon,
    desc: 'تحليل الأداء واستخلاص الملاحظات لتحسين العمليات المستقبلية',
  },
  {
    title: 'إغلاق العملية',
    icon: FileCheckIcon,
    ...
    <section className="relative py-24 overflow-hidden bg-black/70" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <div className="relative mx-auto p-[5%] z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-amber-200 text-base md:text-xl bg-amber-950/50 border-2 border-amber-500/70 rounded-lg px-6 py-2 w-fit mx-auto">من أول مكالمة حتى التسليم</p>
        </div>
