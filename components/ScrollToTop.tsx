    ...
    <>
      <style>{`
        ...
        .stt-disc {
          ...
          inset: 5px;
          border-radius: 50%;
          background: var(--color-secondary, #181f29);
          display: flex;
          align-items: center;
        ...
        /* Progress ring */
        .stt-ring-track {
          stroke: rgba(253,153,8,0.22);
          fill: none;
          transition: stroke 0.2s ease;
        }

        .stt-btn:hover .stt-ring-track {
          stroke: rgba(253,153,8,0.34);
        }

        .stt-ring-progress {
          fill: none;
          stroke: var(--color-primary, #fd9908);
        ...
        .stt-btn:hover .stt-ring-progress {
          stroke: #ffb547;
          filter: drop-shadow(0 0 4px rgba(253,153,8,0.8));
        }
        ...
        .stt-tooltip {
          ...
          padding: 5px 10px;
          border-radius: 6px;
          border: 1px solid rgba(253,153,8,0.5);
          pointer-events: none;
          opacity: 0;
          transition:
            opacity 0.15s ease,
        ...
        .stt-tooltip::after {
          ...
          border-left-color: rgba(253,153,8,0.5);
          margin-left: -1px;
        }
        ...
        .stt-ripple {
          ...
          inset: 5px;
          border-radius: 50%;
          border: 1.5px solid rgba(253,153,8,0.65);
